      ...
      <div class="card shadow-lg">
       ...
       ?>
          ...
          <form action="logincode.php" method="POST">
            ...
            <!-- Submit Button -->
            <div class="d-grid">
              <button type="submit" class="btn btn-primary" name="doc_login_btn">
        ...
        <div class="card-footer text-center bg-light">
          <small class="text-muted">Don't have an account? <a href="../User/d-registration.php" class="text-primary">Register
              here</a></small>
        </div>
      </div>
    </div>
